...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-12 mb-2 text-center">
            <h1>Medical Online Courses</h1>
        </div>
    </div>
    <div class="row justify-content-center my-2"> 
        <div class="col-lg-4 col-sm-8 col-10 mt-3 mb-5">
            <div class="card">
                <img src="https://img.freepik.com/free-photo/portrait-smiling-asian-medical-male-doctor-standing-front-blurred-interior-hospital_7191-974.jpg?size=626&ext=jpg" alt="Avatar" style="height: 200px;">
                <div class="middle">
                    <div class="text"><a href="doctor-update" class="links">Details</a></div>
                    </div>
                <div class="box">
        ...
        <div class="col-lg-4 col-sm-8 col-10 mt-3 mb-5">
            <div class="card">
                <img src="https://img.freepik.com/free-vector/illustration-healthy-lifestyle_53876-28533.jpg?size=626&ext=jpg" alt="Avatar" style="height: 200px;">
                <!-- <div class="middle2"> 
                    <div class="text2">Diskon 20%</div>
                </div> -->
                <div class="middle">
                    <div class="text"><a href="penyakit-dalam" class="links">Details</a></div>
                    </div>
                <div class="box">
                    <h4><b>Penyakit Dalam</b></h4> 
                    <div class="row">
                        <div class="col-lg-12 col-12" style="color: darklatesgray">
                            <a style="font-size:14px"><i class="fa fa-graduation-cap"></i> dr. Tengku Bahdar Johan, SpPD</a>
                        </div>
                        <div class="col-lg-6 col-6 ">
        ...
        <div class="col-lg-4 col-sm-8 col-10 mt-3 mb-5">
            <div class="card">
                ...
                <div class="middle">
                    <div class="text"><a href="anatomy" class="links">Details</a></div>
                    </div>
                <div class="box">
                    <h4><b>Anatomy</b></h4> 
                    <div class="row">
                        <div class="col-lg-12 col-12" style="color: darklatesgray">
                            <a style="font-size:14px"><i class="fa fa-graduation-cap"></i> dr. Alvin Wiharja Sp.KO</a>
                        </div>
                        <div class="col-lg-6 col-6 ">
                            <!-- <a style="font-size:14px"><i class="fa fa-users"></i> 50 Participants</a>  -->
                        </div>
                    </div>
                </div>
            </div>  
        ...
        <div class="col-lg-4 col-sm-8 col-10 mt-3 mb-5">
            <div class="card">
                ...
                <div class="middle">
                    <div class="text"><a href="mental-health" class="links">Details</a></div>
                    </div>
                <div class="box">
