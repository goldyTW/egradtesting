...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-sm-10 col-12 mb-2 text-center">
            <h1>Online Class Manajemen SDM</h1>
            <h4>Andarjuangsyah Sihombing</h4>
        </div>
    </div>
    <div class="row justify-content-center">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-11 col-sm-10 col-10 cardcourse p-3 mt-5 mb-1">
            ...
            Selebihnya dapat anda download <a href="https://drive.google.com/drive/folders/1oGPGSb2FmJrUUPGX7HsCDqZYty0K5cp4?usp=sharing">disini</a>
        </div>
    </div>
</div>
@endsection 