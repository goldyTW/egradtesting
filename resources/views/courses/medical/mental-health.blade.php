...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-sm-10 col-12 mb-2 text-center">
            <h1>Online Class Mental Health</h1>
            <h4>dr. Chrisna Mayangsari, Sp.KJ</h4>
        </div>
    </div>
    <div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-sm-10 col-10 cardcourse mt-5 mb-1 p-3 ml-lg-2">
            <h3><b>Video Online Class</b></h3>
                ...
                @foreach($selectedcourse as $sc)
                    ...
                    @elseif (Auth::user()->email!=$sc->email)
                    <script>
                        document.getElementById("belikelas").style.display = "block";
                    </script>
                    @endif
    ...
    <div class="row justify-content-center">
        <div class="col-lg-11 col-sm-10 col-10 cardcourse p-3 mt-5 mb-1">
            ...
            Pertanyaan dan Jawaban dapat anda download <a href="https://drive.google.com/drive/folders/1hVUaXxgSCe5_xymZ7N6AUTkk_U21UYfe?usp=sharing">disini</a>
        </div>
    </div>
</div>
@endsection 