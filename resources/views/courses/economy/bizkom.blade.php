...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-sm-10 col-12 mb-2 text-center">
            <h1>Online Class Business Communication</h1>
            <h4>Monalisa Iqbal</h4>
        </div>
    </div>
    <div class="row justify-content-center">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-11 col-sm-10 col-10 cardcourse p-3 mt-5 mb-1">
            ...
            Pertanyaan dan Jawaban dapat anda download <a href="https://drive.google.com/drive/folders/1r73QizE7FjHqoaP0i7WQImzqKRZpSwQh?usp=sharing">disini</a>
        </div>
    </div>
</div>
@endsection 