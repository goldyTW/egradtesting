        ...
        <img src="../../assets/egradalt1.png" width="60px" class="mx-2">
            ...
            <div class="collapse navbar-collapse" id="navbarNav" style="z-index: 99;">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2 my-1" href="daftarevent">Pendaftaran Acara<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 col-12 mb-3 text-center">
                    <h2 style="color: white;">Masukan Password Baru</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-8 col-10 card">
                    ...
                    <input type="hidden" name="token" value="{{ $token }}">
                        ...
                        <div class="row justify-content-center mt-5 animate__animated animate__fadeInUp">
                            <div class="col-lg-6 col-10">
                                ...
                                @enderror
                                <label style="font-size: 12px; font-weight: bold;">Masukan Kembali Password Baru</label>
                        ...
                        <div class="row justify-content-center animate__animated animate__fadeInUp">
                            <div class="col-lg-12 text-center">
                                <button class="btn ml-3 mb-4 px-5 py-2 text-center submit" type="submit" id="login">Reset Password</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <!-- @if ($message = Session::get('error'))
                        <script>
                            swal({
                                title: "Gagal!",
                                text: "Reset Password Gagal! Silahkan coba lagi",
                                icon: "error",
